...
namespace margelo::nitro::camera {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "PhotoOutputOptions" and the Kotlin data class "PhotoOutputOptions".
   */
  ...
  public:
    ...
    PhotoOutputOptions toCpp() const {
      ...
      static const auto fieldEnableDepthDataDelivery = clazz->getField<jni::JBoolean>("enableDepthDataDelivery");
      jni::local_ref<jni::JBoolean> enableDepthDataDelivery = this->getFieldValue(fieldEnableDepthDataDelivery);
      ...
      return PhotoOutputOptions(
        ...
        enableDepthDataDelivery != nullptr ? std::make_optional(static_cast<bool>(enableDepthDataDelivery->value())) : std::nullopt,
  ...
  public:
    ...
    static jni::local_ref<JPhotoOutputOptions::javaobject> fromCpp(const PhotoOutputOptions& value) {
      ...
      return create(
        ...
        value.enableDepthDataDelivery.has_value() ? jni::JBoolean::valueOf(value.enableDepthDataDelivery.value()) : nullptr,
