...
namespace margelo::nitro::camera {
  ...
  public:
    ...
    std::optional<bool> enableDepthDataDelivery     SWIFT_PRIVATE;
    std::optional<Size> previewImageTargetSize     SWIFT_PRIVATE;

  public:
    PhotoOutputOptions() = default;
    explicit PhotoOutputOptions(Size targetResolution, TargetPhotoContainerFormat containerFormat, double quality, QualityPrioritization qualityPrioritization, std::optional<bool> enableDepthDataDelivery, std::optional<Size> previewImageTargetSize): targetResolution(targetResolution), containerFormat(containerFormat), quality(quality), qualityPrioritization(qualityPrioritization), enableDepthDataDelivery(enableDepthDataDelivery), previewImageTargetSize(previewImageTargetSize) {}
  ...
  struct JSIConverter<margelo::nitro::camera::PhotoOutputOptions> final {
    static inline margelo::nitro::camera::PhotoOutputOptions fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::camera::PhotoOutputOptions(
        ...
        JSIConverter<std::optional<bool>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "enableDepthDataDelivery"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::camera::PhotoOutputOptions& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "enableDepthDataDelivery"), JSIConverter<std::optional<bool>>::toJSI(runtime, arg.enableDepthDataDelivery));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<bool>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "enableDepthDataDelivery")))) return false;
