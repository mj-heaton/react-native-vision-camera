...
open class HybridPhotoSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridPhotoSpec_cxx) -> Bool {
  ...
  public final var containerFormat: Int32 {
    @inline(__always)
    get {
      return self.__implementation.containerFormat.rawValue
    }
  }
  ...
  public final var calibrationData: bridge.std__optional_std__shared_ptr_HybridCameraCalibrationDataSpec__ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_std__shared_ptr_HybridCameraCalibrationDataSpec__ in
        if let __unwrappedValue = self.__implementation.calibrationData {
  ...
  @inline(__always)
  public final func saveToFileAsync(path: std.string) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.saveToFileAsync(path: String(path))
  ...
  @inline(__always)
  public final func saveToTemporaryFileAsync() -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.saveToTemporaryFileAsync()
